...
namespace TestCpeConnect.NetworkinService
{
    public class PemKeyUtils
    {
        const string pemprivheaderRsa = "-----BEGIN RSA PRIVATE KEY-----";
        const string pemprivfooterRsa = "-----END RSA PRIVATE KEY-----";
        ...
        {
            const string pemprivheader = pemprivheaderRsa;
            const string pemprivfooter =pemprivfooterRsa;
            string pemstr = instr.Trim();
            byte[] binkey;
